          ...
          {isLoading ? (
            ...
            <div className="w-full px-4 flex pb-11 gap-4">
              ...
              <div className="flex flex-col gap-1 flex-1">
                ...
                <div className="min-h-6 !max-h-80 overflow-auto overflow-x-hidden mb-3">
                  <DraftEditor
                    placeholder={placeholder}
                    wrapperClassName="!min-h-6 !max-h-80 !border-none w-full"
                    editorClassName="placeholder:text-muted-foreground outline-0 px-0 focus-visible:outline-none text-[18px] resize-none !py-0 w-full focus:border-0 !border-none"
                ...
                <div className="flex items-center">
                  {base64 && (
                    <div className="w-14 h-14 relative rounded-md border verflow-hidden">
                      <Image
                        src={base64 || ""}
                        width={44}
                        height={44}
                ...
                <hr className="px-3  h-[0.5px] w-full opacity-0 dark:border-[rgb(34,37,40)] mb-1 transition" />
                <div className="w-full flex items-center justify-between">
                  ...
                  <Button
                    ...
                    className="!h-auto !text-white cursor-pointer font-semibold text-base"
                  >
                    {loading ? (
