...
const PostItem: React.FC<PropsType> = ({ post, userId }) => {
  ...
  return (
    <div
      role="button"
      onClick={goToPost}
      className="w-full border-b-[1px] dark:border-[rgb(47,51,54)] p-5 transition"
    >
        ...
        <div className="w-full">
          <div className="flex items-center gap-[4px]">
            ...
            <div className="flex items-center">
              <span className="!text-[#1f2e3b] text-sm">
                <Dot size="15px" />
              </span>
          ...
          <div className="flex flex-row items-center mt-3 gap-10">
            <div
              role="button"
              className="flex flex-row items-center gap-1 text-[#959fa8] cursor-pointer transition hover:text-primary"
            >
            ...
            <div
              role="button"
              className={`flex flex-row items-center gap-1 text-[#959fa8] cursor-pointer transition hover:text-red-500 ${
