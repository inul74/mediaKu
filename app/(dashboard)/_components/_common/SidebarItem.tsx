...
const SidebarItem: React.FC<PropsType> = ({
  ...
  return (
    ...
    >
      ...
      <div
        className="relative hidden lg:flex gap-4 p-3 py-3 w-full rounded-full hover:bg-slate-300 hover:bg-opacity-10 cursor-pointer items-center"
      ...
      >
        {isUser && userInfo ? (
          ...
          <>
            ...
            {alert && (
              <Dot size={70} className="text-primary absolute -top-5 -left-1" />
            )}
          </>
        )}
      </div>
