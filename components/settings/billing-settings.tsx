...
const BillingSettings = async () => {
  ...
  return (
    <div className="w-full px-4 pt-5">
      ...
      <div className="flex justify-start lg:justify-center mt-4 gap-2">
        {plan && plan === PLAN_TYPE.FREE ? (
          ...
          <div className="relative w-full max-w-[350px] h-[220px]">
            ...
            />
            <div className="absolute top-0 rounded-lg left-0 w-ful h-full flex items-center justify-center inset-0 bg-black/20">
              <SubscriptionButton />
            </div>
          </div>
        ) : null}
